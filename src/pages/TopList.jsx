...
function TopList() {
  const { id } = useParams();
  const { products } = Transfer("http://localhost:3000/products/" + id);
        ...
        <div className="list-wrapper container">
          <div className="list-box">
            <div className="list-box-left">
              <img className="data-img" src={products.img} alt="" />
            </div>
            <div className="list-box-right">
              ...
              <div className="price-box">
                <h4 className="one">{products.price}</h4>
                <h4 className="two">{products.oldPrice}</h4>
                <button>{products.sale}</button>
              </div>
              <p>{products.text}</p>
              <hr />
