...
function AllProducts() {
  const { id } = useParams();
  const { allproducts } = Transfer("http://localhost:3000/allproducts/" + id);
  const { data } = Transfer("http://localhost:3000/shirts/");
        ...
        <div className="list-wrapper container">
          <div className="list-box">
            <div className="list-box-left">
              <img className="data-img" src={allproducts.img} alt="" />
            </div>
            <div className="list-box-right">
              <h2>{allproducts.title}</h2>
              <div className="evaluate-box">
                <img src={stars} alt="" />
                <span>4.5/5</span>
              </div>
              <div className="price-box">
                <h4 className="one">{allproducts.price}</h4>
                <h4 className="two">{allproducts.oldPrice}</h4>
                <button>{allproducts.sale}</button>
              </div>
              <p>{allproducts.text}</p>
              <hr />
